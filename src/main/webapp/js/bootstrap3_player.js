...
(function ($) {'use strict';
    $('audio[controls]').before(function () {
        ...
        var load_error = function () {
            ...
            $(player_box).find('.glyphicon-refresh').parent().attr('title', 'Error while loading the audio.');
        ...
        var addPlay = function () {
            ...
            $(play).addClass('btn btn-play btn-default disabled col-sm-1');
            ...
            var loadCheck = setInterval(function () {
                ...
                /*if (song.networkState === 3 || timeout === 1000) {
    ...
    // custom edit
    $('img.thumbnail').addClass("col-md-4 col-sm-4 col-xs-12");
    $('table.table').addClass("col-md-8 col-sm-8 col-xs-12");
})(jQuery);
