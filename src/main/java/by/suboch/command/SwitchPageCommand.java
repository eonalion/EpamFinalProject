...
import static by.suboch.command.CommandConstants.ATTR_TRACK_LIST;
...
public class SwitchPageCommand implements IServletCommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            request.getSession().setAttribute(ATTR_TRACK_LIST, trackLogic.showPopularTracks(pageNumber*CommandConstants.TRACKS_PER_PAGE, CommandConstants.TRACKS_PER_PAGE));
